...
#elif (((USBD3_CDC_CNT == 1U) && (USBD3_CDC_ACM_CNT == 1U)) || \
       ((USBD3_CDC_CNT == 1U) && (USBD3_CDC_NCM_CNT == 1U)))
...
typedef const __PACKED_STRUCT {
  ...
  uint8_t  type;
  uint16_t langid;
#ifdef USBD3_STR_DESC_MAN_RAW
  USBD_STR_DEF_u(0,  USBD3_STR_DESC_MAN_RAW);
#else
  USBD_STR_DEF  (0,  USBD3_STR_DESC_MAN);
#endif
#ifdef USBD3_STR_DESC_PROD_RAW
  USBD_STR_DEF_u(1,  USBD3_STR_DESC_PROD_RAW);
#else
  USBD_STR_DEF  (1,  USBD3_STR_DESC_PROD);
#endif
#if (USBD3_STR_DESC_SER_EN)
#ifdef USBD3_STR_DESC_SER_RAW
  USBD_STR_DEF_u(2,  USBD3_STR_DESC_SER_RAW);
#else
  USBD_STR_DEF  (2,  USBD3_STR_DESC_SER);
#endif
#endif
...
} usbd3_string_descriptor_t;

extern usbd3_string_descriptor_t usbd3_string_descriptor;
__WEAK usbd3_string_descriptor_t usbd3_string_descriptor __ALIGNED(4) = {
  4, USB_STRING_DESCRIPTOR_TYPE, USBD3_STR_DESC_LANGID,
#ifdef USBD3_STR_DESC_MAN_RAW
  USBD_STR_VAL_u(USBD3_STR_DESC_MAN_RAW),
#else
  USBD_STR_VAL  (USBD3_STR_DESC_MAN),
#endif
#ifdef USBD3_STR_DESC_PROD_RAW
  USBD_STR_VAL_u(USBD3_STR_DESC_PROD_RAW),
#else
  USBD_STR_VAL  (USBD3_STR_DESC_PROD),
#endif
#if (USBD3_STR_DESC_SER_EN)
#ifdef USBD3_STR_DESC_SER_RAW
  USBD_STR_VAL_u(USBD3_STR_DESC_SER_RAW),
#else
...
#if ((USBD3_STR_DESC_SER_EN != 0) && (USBD3_STR_DESC_SER_MAX_LEN > 0))
typedef __PACKED_STRUCT {
  uint8_t  bLength;
  uint8_t  bDescriptorType;
  uint16_t bString[USBD3_STR_DESC_SER_MAX_LEN];
} usbd3_ser_num_string_descriptor_t;

static usbd3_ser_num_string_descriptor_t usbd3_ser_num_string_descriptor __ALIGNED(4);
#endif

#if (USBD3_OS_DESC_EN != 0)
// Microsoft OS String Descriptor
static const uint8_t usbd3_ms_os_string_descriptor[18] __ALIGNED(4) = {
  USBD_MS_OS_STR(0)
};

#if ((USBD3_CUSTOM_CLASS_MS_COMPAT_CNT != 0) || (USBD3_CDC_MS_COMPAT_CNT != 0))
// Microsoft Extended Compat ID OS Feature Descriptor
typedef const __PACKED_STRUCT {
  USBD_MS_OS_FEAT_EXT_COMPAT_ID_HEADER_DEF
#if  (USBD3_CUSTOM_CLASS0 == 1)
...
#if ((USBD3_CDC0 == 1) && (USBD3_CDC0_ACM == 1) && (USBD3_CDC0_RNDIS == 1))
  USBD_MS_OS_FEAT_EXT_COMPAT_ID_FUNCTION_DEF(CDC0,0)
#endif
#if ((USBD3_CDC1 == 1) && (USBD3_CDC1_ACM == 1) && (USBD3_CDC1_RNDIS == 1))
  USBD_MS_OS_FEAT_EXT_COMPAT_ID_FUNCTION_DEF(CDC1,1)
#endif
#if ((USBD3_CDC2 == 1) && (USBD3_CDC2_ACM == 1) && (USBD3_CDC2_RNDIS == 1))
  USBD_MS_OS_FEAT_EXT_COMPAT_ID_FUNCTION_DEF(CDC2,2)
#endif
#if ((USBD3_CDC3 == 1) && (USBD3_CDC3_ACM == 1) && (USBD3_CDC3_RNDIS == 1))
  USBD_MS_OS_FEAT_EXT_COMPAT_ID_FUNCTION_DEF(CDC3,3)
#endif
#if ((USBD3_CDC4 == 1) && (USBD3_CDC4_ACM == 1) && (USBD3_CDC4_RNDIS == 1))
  USBD_MS_OS_FEAT_EXT_COMPAT_ID_FUNCTION_DEF(CDC4,4)
#endif
#if ((USBD3_CDC5 == 1) && (USBD3_CDC5_ACM == 1) && (USBD3_CDC5_RNDIS == 1))
  USBD_MS_OS_FEAT_EXT_COMPAT_ID_FUNCTION_DEF(CDC5,5)
#endif
#if ((USBD3_CDC6 == 1) && (USBD3_CDC6_ACM == 1) && (USBD3_CDC6_RNDIS == 1))
  USBD_MS_OS_FEAT_EXT_COMPAT_ID_FUNCTION_DEF(CDC6,6)
#endif
#if ((USBD3_CDC7 == 1) && (USBD3_CDC7_ACM == 1) && (USBD3_CDC7_RNDIS == 1))
  USBD_MS_OS_FEAT_EXT_COMPAT_ID_FUNCTION_DEF(CDC7,7)
#endif
} usbd3_ms_os_ext_compat_id_descriptor_t;

static const usbd3_ms_os_ext_compat_id_descriptor_t usbd3_ms_os_ext_compat_id_descriptor __ALIGNED(4) = {
  USBD_MS_OS_FEAT_EXT_COMPAT_ID_HEADER_VAL(0, (USBD3_CUSTOM_CLASS_MS_COMPAT_CNT + USBD3_CDC_MS_COMPAT_CNT))
#if  (USBD3_CUSTOM_CLASS0 == 1)
#if ((USBD_CUSTOM_CLASS0_IF0_EN == 1) && (USBD_CUSTOM_CLASS0_IF0_OS_EXT_COMPAT_ID_EN == 1))
...
usbd_desc_t usbd3_desc = {
  ...
  usbd3_device_qualifier_fs,
  usbd3_device_qualifier_hs,
  usbd3_config_descriptor_fs,
  usbd3_config_descriptor_hs,
  usbd3_other_speed_config_descriptor_fs,
  usbd3_other_speed_config_descriptor_hs,
  (const uint8_t *)(&usbd3_string_descriptor),
#if ((USBD3_STR_DESC_SER_EN != 0) && (USBD3_STR_DESC_SER_MAX_LEN > 0))
  (uint8_t *)(&usbd3_ser_num_string_descriptor),
#else
  NULL,
#endif
#if (USBD3_OS_DESC_EN != 0)
  usbd3_ms_os_string_descriptor,
#else
  NULL,
#endif
#if ((USBD3_OS_DESC_EN != 0) && ((USBD3_CUSTOM_CLASS_MS_COMPAT_CNT != 0) || (USBD3_CDC_MS_COMPAT_CNT != 0)))
  (const uint8_t *)(&usbd3_ms_os_ext_compat_id_descriptor),
#else
  NULL,
#endif
};
