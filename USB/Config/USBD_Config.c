...
#define USBD%Instance%_STR_DESC_MAN_RAW          "Keil Software"

//     <s.126>Product String
//     <i>String Descriptor describing Product.
#define USBD%Instance%_STR_DESC_PROD_RAW         "Keil USB Device %Instance%"
...
#define USBD%Instance%_STR_DESC_SER_RAW          "0001A0000000"
