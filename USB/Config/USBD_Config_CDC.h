...
#define USBD_CDC%Instance%_CIF_STR_DESC_RAW       "USB_CDC%Instance%_0"

//     <s.126>Data Class Interface String
#define USBD_CDC%Instance%_DIF_STR_DESC_RAW       "USB_CDC%Instance%_1"
...
#define USBD_CDC%Instance%_NCM_MAC_ADDRESS_RAW    "1E306CA2455E"
