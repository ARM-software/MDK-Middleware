 ...
 *------------------------------------------------------------------------------
 * Name:    usbh_lib_ehci_tt.h
 * Purpose: USB Host - EHCI Generic Layer Driver header file
 *----------------------------------------------------------------------------*/

#ifndef __USBH_LIB_EHCI_TT_H__
#define __USBH_LIB_EHCI_TT_H__
