...
/* Last-Modified: Thu, 01 Aug 2024 08:20:51 GMT */
const uint32_t imageLastModified = 1722500451U;
...
static const imageFileItem imageFileTable[11U+1U] = {
  ...
  { 0x1D1F9D3EU, &imageFileData[2104U]  },    // "pg_header.inc"
  { 0x85C7B8E6U, &imageFileData[3152U]  },    // "pg_footer.inc"
  { 0xDE703953U, &imageFileData[3578U]  },    // "home.png"
  { 0x90CE4E8AU, &imageFileData[4967U]  },    // "keil.gif"
  { 0xB857F2BFU, &imageFileData[6105U]  },    // "arm.png"
  { 0x7049A0E1U, &imageFileData[8953U]  },    // "llblue.jpg"
  { 0x3BDBDB05U, &imageFileData[11961U] },    // "pabb.gif"
  { 0xC48DAE83U, &imageFileData[12082U] },    // "upload.cgi"
  { 0xCE01AC41U, &imageFileData[12723U] },    // "dir.cgi"
  { 0x9654BF31U, &imageFileData[13023U] },    // "format.cgi"
