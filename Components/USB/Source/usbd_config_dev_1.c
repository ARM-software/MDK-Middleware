...
uint8_t     usbd1_ep0_buf      [((USBD1_EP0_BUF_SIZE+31)/32)*32] __ALIGNED(32) USBD1_DEV_BUF_MEM_SECTION;
extern 
...
static osRtxThread_t  usbd1_core_thread_cb_mem                                              __attribute__((section(".bss.os.thread.cb")));
static uint64_t       usbd1_core_thread_stack_mem[(USBD1_CORE_THREAD_STACK_SIZE + 7U) / 8U] __attribute__((section(".bss.os.thread.stack")));
#endif
extern 
