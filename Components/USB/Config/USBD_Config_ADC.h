...
#define USBD_ADC%Instance%_DEV                       %Instance%
...
#define USBD_ADC%Instance%_CIF_STR_DESC_RAW          "USB_ADC%Instance%"

//     <h>Audio Output Settings (Speaker)

//       <s.126>Audio Streaming (Zero Bandwidth) Interface String
#define USBD_ADC%Instance%_OUT_SIF_STR0_DESC_RAW     "USB_ADC%Instance%_SPKR_OFF"

//       <s.126>Audio Streaming (Operational) Interface String
#define USBD_ADC%Instance%_OUT_SIF_STR1_DESC_RAW     "USB_ADC%Instance%_SPKR_ON"
...
//       <s.126>Audio Streaming (Zero Bandwidth) Interface String
#define USBD_ADC%Instance%_IN_SIF_STR0_DESC_RAW      "USB_ADC%Instance%_MIC_OFF"

//       <s.126>Audio Streaming (Operational) Interface String
#define USBD_ADC%Instance%_IN_SIF_STR1_DESC_RAW      "USB_ADC%Instance%_MIC_ON"
