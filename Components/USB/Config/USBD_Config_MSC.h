...
#define USBD_MSC%Instance%_DEV                   %Instance%
...
#define USBD_MSC%Instance%_STR_DESC_RAW          "USB_MSC%Instance%"

//     <o0.0..1>Maximum Number of Logical Units (LUN)
//     <i>For single LUN use 1, otherwise 2-4.
//       <0=>1 <1=>2 <2=>3 <3=>4
#define USBD_MSC%Instance%_MAX_LUN               0
...
//       <s1.16>Product Identification
//       <s2.4>Product Revision Level
#define USBD_MSC%Instance%_LUN1_INQUIRY_DATA     "Keil    "         \
                                        "Disk LUN 1      " \
                                        "1.0 "
...
//       <s1.16>Product Identification
//       <s2.4>Product Revision Level
#define USBD_MSC%Instance%_LUN2_INQUIRY_DATA     "Keil    "         \
                                        "Disk LUN 2      " \
                                        "1.0 "
...
//       <s1.16>Product Identification
//       <s2.4>Product Revision Level
#define USBD_MSC%Instance%_LUN3_INQUIRY_DATA     "Keil    "         \
                                        "Disk LUN 3      " \
                                        "1.0 "
