...
#elif (((USBD$x_CDC_CNT == 1U) && (USBD$x_CDC_ACM_CNT == 1U)) || \
       ((USBD$x_CDC_CNT == 1U) && (USBD$x_CDC_NCM_CNT == 1U)))
...
#endif
  USBD$x_MAX_PACKET0,                    /* bMaxPacketSize0 */
  WBVAL(USBD$x_DEV_DESC_IDVENDOR),       /* idVendor */
  WBVAL(USBD$x_DEV_DESC_IDPRODUCT),      /* idProduct */
  WBVAL(USBD$x_DEV_DESC_BCDDEVICE),      /* bcdDevice */
  0x01,                                 /* iManufacturer */
  0x02,                                 /* iProduct */
  0x03*USBD$x_STR_DESC_SER_EN,           /* iSerialNumber */
...
__WEAK const uint8_t usbd$x_config_descriptor_fs[] __ALIGNED(4) = {
  ...
  WBVAL(USBD$x_WTOTALLENGTH),            /* wTotalLength */
  USBD$x_IF_CNT,                         /* bNumInterfaces */
  0x01,                                 /* bConfigurationValue: 0x01 is used to select this configuration */
  0x00,                                 /* iConfiguration: no string to describe this configuration */
  USBD$x_CFG_DESC_BMATTRIBUTES,          /* bmAttributes */
  USBD$x_CFG_DESC_BMAXPOWER,             /* bMaxPower, device power consumption */

#if (USBD$x_CUSTOM_CLASS0)
...
#if (USBD$x_ADC0 || USBD$x_ADC1 || USBD$x_ADC2 || USBD$x_ADC3)
...
typedef const __PACKED_STRUCT {
  ...
  uint8_t  type;
  uint16_t langid;
#ifdef USBD$x_STR_DESC_MAN_RAW
  USBD_STR_DEF_u(0,  USBD$x_STR_DESC_MAN_RAW);
#else
  USBD_STR_DEF  (0,  USBD$x_STR_DESC_MAN);
#endif
#ifdef USBD$x_STR_DESC_PROD_RAW
  USBD_STR_DEF_u(1,  USBD$x_STR_DESC_PROD_RAW);
#else
  USBD_STR_DEF  (1,  USBD$x_STR_DESC_PROD);
#endif
#if (USBD$x_STR_DESC_SER_EN)
#ifdef USBD$x_STR_DESC_SER_RAW
  USBD_STR_DEF_u(2,  USBD$x_STR_DESC_SER_RAW);
#else
  USBD_STR_DEF  (2,  USBD$x_STR_DESC_SER);
#endif
#endif
...
} usbd$x_string_descriptor_t;

extern usbd$x_string_descriptor_t usbd$x_string_descriptor;
__WEAK usbd$x_string_descriptor_t usbd$x_string_descriptor __ALIGNED(4) = {
  4, USB_STRING_DESCRIPTOR_TYPE, USBD$x_STR_DESC_LANGID,
#ifdef USBD$x_STR_DESC_MAN_RAW
  USBD_STR_VAL_u(USBD$x_STR_DESC_MAN_RAW),
#else
  USBD_STR_VAL  (USBD$x_STR_DESC_MAN),
#endif
#ifdef USBD$x_STR_DESC_PROD_RAW
  USBD_STR_VAL_u(USBD$x_STR_DESC_PROD_RAW),
#else
  USBD_STR_VAL  (USBD$x_STR_DESC_PROD),
#endif
#if (USBD$x_STR_DESC_SER_EN)
#ifdef USBD$x_STR_DESC_SER_RAW
  USBD_STR_VAL_u(USBD$x_STR_DESC_SER_RAW),
#else
  USBD_STR_VAL  (USBD$x_STR_DESC_SER),
#endif
#endif
...
#if ((USBD$x_STR_DESC_SER_EN != 0) && (USBD$x_STR_DESC_SER_MAX_LEN > 0))
typedef __PACKED_STRUCT {
  uint8_t  bLength;
  uint8_t  bDescriptorType;
  uint16_t bString[USBD$x_STR_DESC_SER_MAX_LEN];
} usbd$x_ser_num_string_descriptor_t;

static usbd$x_ser_num_string_descriptor_t usbd$x_ser_num_string_descriptor __ALIGNED(4);
#endif

#if (USBD$x_OS_DESC_EN != 0)
// Microsoft OS String Descriptor
static const uint8_t usbd$x_ms_os_string_descriptor[18] __ALIGNED(4) = {
  USBD_MS_OS_STR(0)
};

#if ((USBD$x_CUSTOM_CLASS_MS_COMPAT_CNT != 0) || (USBD$x_CDC_MS_COMPAT_CNT != 0))
// Microsoft Extended Compat ID OS Feature Descriptor
typedef const __PACKED_STRUCT {
  USBD_MS_OS_FEAT_EXT_COMPAT_ID_HEADER_DEF
#if  (USBD$x_CUSTOM_CLASS0 == 1)
...
#if ((USBD$x_CDC0 == 1) && (USBD$x_CDC0_ACM == 1) && (USBD$x_CDC0_RNDIS == 1))
  USBD_MS_OS_FEAT_EXT_COMPAT_ID_FUNCTION_DEF(CDC0,0)
#endif
#if ((USBD$x_CDC1 == 1) && (USBD$x_CDC1_ACM == 1) && (USBD$x_CDC1_RNDIS == 1))
  USBD_MS_OS_FEAT_EXT_COMPAT_ID_FUNCTION_DEF(CDC1,1)
#endif
#if ((USBD$x_CDC2 == 1) && (USBD$x_CDC2_ACM == 1) && (USBD$x_CDC2_RNDIS == 1))
  USBD_MS_OS_FEAT_EXT_COMPAT_ID_FUNCTION_DEF(CDC2,2)
#endif
#if ((USBD$x_CDC3 == 1) && (USBD$x_CDC3_ACM == 1) && (USBD$x_CDC3_RNDIS == 1))
  USBD_MS_OS_FEAT_EXT_COMPAT_ID_FUNCTION_DEF(CDC3,3)
#endif
#if ((USBD$x_CDC4 == 1) && (USBD$x_CDC4_ACM == 1) && (USBD$x_CDC4_RNDIS == 1))
  USBD_MS_OS_FEAT_EXT_COMPAT_ID_FUNCTION_DEF(CDC4,4)
#endif
#if ((USBD$x_CDC5 == 1) && (USBD$x_CDC5_ACM == 1) && (USBD$x_CDC5_RNDIS == 1))
  USBD_MS_OS_FEAT_EXT_COMPAT_ID_FUNCTION_DEF(CDC5,5)
#endif
#if ((USBD$x_CDC6 == 1) && (USBD$x_CDC6_ACM == 1) && (USBD$x_CDC6_RNDIS == 1))
  USBD_MS_OS_FEAT_EXT_COMPAT_ID_FUNCTION_DEF(CDC6,6)
#endif
#if ((USBD$x_CDC7 == 1) && (USBD$x_CDC7_ACM == 1) && (USBD$x_CDC7_RNDIS == 1))
  USBD_MS_OS_FEAT_EXT_COMPAT_ID_FUNCTION_DEF(CDC7,7)
#endif
} usbd$x_ms_os_ext_compat_id_descriptor_t;

static const usbd$x_ms_os_ext_compat_id_descriptor_t usbd$x_ms_os_ext_compat_id_descriptor __ALIGNED(4) = {
  USBD_MS_OS_FEAT_EXT_COMPAT_ID_HEADER_VAL(0, (USBD$x_CUSTOM_CLASS_MS_COMPAT_CNT + USBD$x_CDC_MS_COMPAT_CNT))
#if  (USBD$x_CUSTOM_CLASS0 == 1)
#if ((USBD_CUSTOM_CLASS0_IF0_EN == 1) && (USBD_CUSTOM_CLASS0_IF0_OS_EXT_COMPAT_ID_EN == 1))
...
usbd_desc_t usbd$x_desc = {
  ...
  usbd$x_device_qualifier_fs,
  usbd$x_device_qualifier_hs,
  usbd$x_config_descriptor_fs,
  usbd$x_config_descriptor_hs,
  usbd$x_other_speed_config_descriptor_fs,
  usbd$x_other_speed_config_descriptor_hs,
  (const uint8_t *)(&usbd$x_string_descriptor),
#if ((USBD$x_STR_DESC_SER_EN != 0) && (USBD$x_STR_DESC_SER_MAX_LEN > 0))
  (uint8_t *)(&usbd$x_ser_num_string_descriptor),
#else
  NULL,
#endif
#if (USBD$x_OS_DESC_EN != 0)
  usbd$x_ms_os_string_descriptor,
#else
  NULL,
#endif
#if ((USBD$x_OS_DESC_EN != 0) && ((USBD$x_CUSTOM_CLASS_MS_COMPAT_CNT != 0) || (USBD$x_CDC_MS_COMPAT_CNT != 0)))
  (const uint8_t *)(&usbd$x_ms_os_ext_compat_id_descriptor),
#else
  NULL,
#endif
};
