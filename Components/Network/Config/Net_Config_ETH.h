...
#define ETH%Instance%_ICMP_NO_ECHO       0
//   </e>

//   <e>IPv6
//   <i>Enable IPv6 Protocol for Network Interface
#define ETH%Instance%_IP6_ENABLE         1
...
//     <i>Default: enabled
#define ETH%Instance%_IP6_FRAG_ENABLE    1

//       <o>MTU size <1280-1500>
//       <i>Maximum Transmission Unit in bytes
//       <i>Default: 1500
#define ETH%Instance%_IP6_MTU            1500
//     </e>
...
//     <i>Default: 512 bytes
#define ETH%Instance%_THREAD_STACK_SIZE  512

//        Interface Thread Priority
#define ETH%Instance%_THREAD_PRIORITY    osPriorityAboveNormal
