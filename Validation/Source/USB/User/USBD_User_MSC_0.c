...
#if    (((MW_CV_USBD != 0U) && ((MW_CV_USBD_CORE != 0U) || (MW_CV_USBD_MSC != 0U))) || \
        ((MW_CV_USBH != 0U) && ((MW_CV_USBH_CORE != 0U) || (MW_CV_USBH_MSC != 0U))))
...
MW_CV_USBD_MSC_t mw_cv_usbd_msc0;
...
void USBD_MSC0_Initialize (void) {
  ...
  mw_cv_usbd_msc0.cb_initialize = true;
...
void USBD_MSC0_Uninitialize (void) {
  ...
  mw_cv_usbd_msc0.cb_uninitialize = true;
}
...
bool USBD_MSC0_GetCacheInfo (uint32_t *buffer, uint32_t *size) {
  ...
  mw_cv_usbd_msc0.cb_get_cache_info = true;
...
bool USBD_MSC0_GetMediaCapacity (uint32_t *block_count, uint32_t *block_size) {
  ...
  mw_cv_usbd_msc0.cb_get_media_capacity = true;
...
#endif
  mw_cv_usbd_msc0.block_count = *block_count;
  mw_cv_usbd_msc0.block_size  = *block_size;
...
uint32_t USBD_MSC0_CheckMedia (void) {
  ...
  mw_cv_usbd_msc0.cb_check_media = true;
