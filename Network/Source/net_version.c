...
#if   defined(Network_IPv6) && defined(Network_Debug_EVR)
extern const uint32_t ASM_LABEL(network_ip4ip6_debug, MAJOR, MINOR, BUILD)
#elif defined(Network_IPv6) && defined(Network_Debug_STDIO)
