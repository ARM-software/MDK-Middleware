...
// constructor for the array of objects
function exttabElement(id, folderName, tabTxt )  {
  this.tabTxt = tabTxt;                               // Text displayed as menu on the web
this.folderName = folderName;                       // folder name of the component 
this.id = id;                                       // elementID as needed in html; 
this.currentListItem = '<li id="' + this.id + '" class="current"> <a href="https://www.keil.com/pack/doc/mw' + this.folderName + 'index.html"><span>' + this.tabTxt + '</span></a></li>';
this.listItem = '<li id="' + this.id + '"> <a href="https://www.keil.com/pack/doc/mw' + this.folderName + 'index.html"><span>' + this.tabTxt + '</span></a></li>';
};
