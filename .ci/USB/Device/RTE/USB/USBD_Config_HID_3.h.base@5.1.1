...
#define USBD_HID3_EP_INT_IN_HS_WMAXPACKETSIZE     4
...
#define USBD_HID3_EP_INT_IN_HS_BINTERVAL          5
...
//           <i>Specifies the physical packet size used for information exchange.
//           <i>Maximum value is 64.
#define USBD_HID3_EP_INT_OUT_WMAXPACKETSIZE       4

//           <o.0..7>Endpoint polling Interval (in ms) <1-255>
//           <i>Specifies the frequency of requests sent by USB Host for setting data.
#define USBD_HID3_EP_INT_OUT_BINTERVAL            16
...
//           <i>Additional transactions improve communication performance.
//             <0=>None <1=>1 additional <2=>2 additional
#define USBD_HID3_EP_INT_OUT_HS_WMAXPACKETSIZE    4
...
//             <9=>  256 <10=> 512 <11=> 1024 <12=> 2048
//             <13=>4096 <14=>8192 <15=>16384 <16=>32768
#define USBD_HID3_EP_INT_OUT_HS_BINTERVAL         5
...
#define USBD_HID3_STR_DESC_RAW                    "USB_HID3"

//     <o.0..4>Number of Input Reports <1-32>
//     <i>Configures max 'rid' value for USBD_HID3_GetReport and USBD_HID_GetReportTrigger
#define USBD_HID3_IN_REPORT_NUM                   1

//     <o.0..4>Number of Output Reports <1-32>
//     <i>Configures max 'rid' value for USBD_HID3_SetReport
#define USBD_HID3_OUT_REPORT_NUM                  1

//     <o.0..15>Maximum Input Report Size (in bytes) <1-65535>
//     <i>Allocates memory and configures 'len' value for USBD_HID3_GetReport
//     <i>and USBD_HID_GetReportTrigger
#define USBD_HID3_IN_REPORT_MAX_SZ                1

//     <o.0..15>Maximum Output Report Size (in bytes) <1-65535>
//     <i>Allocates memory and configures 'len' value for USBD_HID3_SetReport
//     <i>when rtype=HID_REPORT_OUTPUT.
#define USBD_HID3_OUT_REPORT_MAX_SZ               1

//     <o.0..15>Maximum Feature Report Size (in bytes) <1-65535>
//     <i>Allocates memory and configures 'len' value for USBD_HID3_SetReport
//     <i>when rtype=HID_REPORT_FEATURE
#define USBD_HID3_FEAT_REPORT_MAX_SZ              1

//     <e.0>Use User Provided HID Report Descriptor
//     <i>User needs to provide HID Report Descriptor in array
//     <i>const uint8_t usbd_hid3_report_descriptor[]
#define USBD_HID3_USER_REPORT_DESCRIPTOR          0

//       <o>User Provided HID Report Descriptor Size (in bytes) <1-65535>
#define USBD_HID3_USER_REPORT_DESCRIPTOR_SIZE     33
...
#define USBD_HID3_THREAD_STACK_SIZE               512
